...
class DoingFragment : Fragment() {
    ...
    private fun getTasks() {
        val taskList = listOf(
            Task("0", "Criar nova tela do TODO 0", Status.DOING),
            Task("1", "Criar nova tela do app 1", Status.DOING),
            Task("2", "Criar nova tela do app 2", Status.DOING),
            Task("3", "Criar nova tela do app 3", Status.DOING),
            Task("4", "Criar nova tela do app 4", Status.DOING)
        )
